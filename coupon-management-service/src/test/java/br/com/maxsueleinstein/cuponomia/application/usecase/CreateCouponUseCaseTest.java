...
class CreateCouponUseCaseTest {
    ...
    void setUp() {
        ...
        useCase = new CreateCouponUseCase(couponRepository, couponMapper, couponEventPublisher);
    }
    ...
    void shouldCreateFixedCoupon() {
        ...
        verify(couponEventPublisher).couponCreated(any(Coupon.class));
    }
    ...
    void shouldThrowForDuplicateCode() {
        ...
        verifyNoInteractions(couponEventPublisher);
    }
}
