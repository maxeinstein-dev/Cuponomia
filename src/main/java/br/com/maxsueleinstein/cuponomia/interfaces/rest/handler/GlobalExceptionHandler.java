...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(CouponNotFoundException ex,
        ...
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(ErrorResponse.of(404, "Não Encontrado", ex.getMessage(), request.getRequestURI()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleIllegalArgument(IllegalArgumentException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(400, "Requisição Inválida", ex.getMessage(), request.getRequestURI()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex,
        ...
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(400, "Requisição Inválida", "Falha na validação dos dados", errors, request.getRequestURI()));
    }
